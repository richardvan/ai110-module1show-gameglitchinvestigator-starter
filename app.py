...
attempt_limit_map = {
    "Easy": 10,  #FIX: Easy had fewer attempts than Normal, should be more
    "Normal": 8,
    "Hard": 5,
}
...
#FIX: secret was not regenerated when difficulty changed mid-session, so secret could be outside the new range
...
with col1:
    submit = st.button("Submit Guess 🚀", on_click=_capture_guess)
with col2:
